    ...
    <div class="main group <?php echo wpb_option( 'general-sidebar', 'sidebar-right' ); ?>">
        ...
        <div class="content-part">
            <div class="pad group">
				...
				<?php if ( wpb_option( 'featured-slider-enable' ) || wpb_option( 'highlights-enable' ) ) {
					get_template_part( 'partials/featured' );
				} ?>

				<?php if ( is_home() && ! is_paged() ): ?>
					<?php if ( wpb_option( 'home-widgets-top' ) ): ?>
						<?php if ( wpb_option( 'home-widgets-top-title' ) ): ?>
                            <div class="page-title"><h4><i
                                        class="icon-arrow-right"></i><?php echo wpb_option( 'home-widgets-top-title' ); ?>
                            </h4></div><?php endif; ?>
				...
				<?php
				if ( wpb_option( 'blog-standard-home' ) ) {
				...
				<?php if ( is_home() && ! is_paged() ): ?>
					<?php if ( wpb_option( 'home-widgets-bottom' ) ): ?>
						<?php if ( wpb_option( 'home-widgets-bottom-title' ) ): ?>
                            <div class="page-title"><h4><i
                                        class="icon-arrow-right"></i><?php echo wpb_option( 'home-widgets-bottom-title' ); ?>
                            </h4></div><?php endif; ?>
