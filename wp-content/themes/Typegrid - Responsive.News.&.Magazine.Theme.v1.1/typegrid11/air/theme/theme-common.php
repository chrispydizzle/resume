...
function wpbandit_seo() {
	...
	if ( is_author() ) {
		...
		if ( $noindex ) {
			$seo_robot_atts['content'][] = 'noindex';
		}
		if ( $noarchive ) {
			$seo_robot_atts['content'][] = 'noarchive';
		}
		if ( $nofollow ) {
			$seo_robot_atts['content'][] = 'nofollow';
		}
	}
	...
	if ( $noodp ) {
		$seo_robot_atts['content'][] = 'noodp';
	}
	if ( $noydir ) {
		$seo_robot_atts['content'][] = 'noydir';
	}
