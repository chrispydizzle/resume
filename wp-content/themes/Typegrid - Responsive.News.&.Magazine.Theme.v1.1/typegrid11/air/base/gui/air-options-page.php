    ...
    <div id="air-content">
        ...
        <div id="air-main">
            ...
            <div id="air-subheader">
                ...
                <ul id="air-headmenu">
                    <li><a href="http://wpbandit.com/themes/" target="_blank"><i class="air-icon air-icon-themes"></i>More
                            Themes</a></li>
                    <li><a href="http://wpbandit.com/forums/" target="_blank"><i class="air-icon air-icon-forums"></i>View
                            Forums</a></li>
                    <li <?php if ( 'changelog' == $section ) {
						echo 'class="current"';
					} ?>><a href="<?php echo admin_url( '/admin.php?page=theme-options&section=changelog' ); ?>"><i
                                    class="air-icon air-icon-changelog"></i>View Changelog</a></li>
                </ul>
            </div><!--/air-subheader-->
            ...
            <form method="post" action="options.php">
                <div id="air-main-inner" class="air-text">
					<?php if ( 'changelog' !== $section ): ?>
                        ...
                        <input type="hidden" name="<?php echo Air::get( 'theme-options' ); ?>[section]"
                ...
                <div id="air-footer">
                    <p class="submit air-submit">
                        <input type="submit" name="<?php echo Air::get( 'theme-options' ); ?>[reset]"
                               class="button-secondary" value="Reset Options"/>
