                    ...
                    <form class="air-social-form" method="post" action="options.php">
                        ...
                        <div class="air-box-inner">
                            <p>
                                ...
                                <input id="social-item-url" name="air-social[url]" type="text" class="large-text"
                                       value="http://">
                            </p>
                ...
                <div class="air-box second">
                    ...
                    <div class="air-box-inner">
                        <div id="air-social-icons">
                            ...
                            <p class="air-credit">Full list of usable icons: <a
                                        href="http://fortawesome.github.com/Font-Awesome/" target="_blank">Font
                                    Awesome</a></p>
                        </div>
                    </div>
                </div><!--/air-box-->
                ...
                <div id="air-social-content">
                    <div>
                        <table class="air-table" cellpadding="0" cellspacing="0">
							...
							<?php foreach ( $items as $key => $item ): ?>
                                <tr>
                                    <td class="icon">
                                        ...
                                        <input name="<?php echo 'air-social[' . $key . ']'; ?>[icon]" type="text"
                                               class="code" value="<?php echo $item['icon']; ?>">
                                    </td>
                                    <td class="link">
                                        <input name="<?php echo 'air-social[' . $key . ']'; ?>[url]" type="text"
                                               class="code" value="<?php echo $item['url']; ?>"><br>
                                        <div class="new-window"><input
                                                    name="<?php echo 'air-social[' . $key . ']'; ?>[new-window]"
                                                    type="checkbox" <?php checked( $item['new-window'], 1 ); ?>> Open in
                                            new window
                                        </div>
                                    </td>
                                    <td class="title">
                                        <input name="<?php echo 'air-social[' . $key . ']'; ?>[name]" type="text"
                                               class="code" value="<?php echo $item['name']; ?>">
                                    </td>
                                    <td class="actions">
                                        <a href="#" class="air-link-move"><img src="<?php echo $url; ?>/img/move.png"
                                                                               alt="Move" title="Drag to Move"/></a>
                                        <a href="#" class="air-link-delete"><img
                                                    src="<?php echo $url; ?>/img/delete.png" alt="Delete"/></a>
                                    </td>
                                </tr>
							<?php endforeach; ?>
                            </tbody>
                            ...
                            <tr>
                                <td colspan="4">
                                    <p class="air-credit">Module inspired by <a
                                                href="http://shakenandstirredweb.com/plugins/social-bartender/"
                                                target="_blank">Sawyer Hollenshead</a></p>
                                </td>
                            </tr>
                            </tfoot>
                        </table>
