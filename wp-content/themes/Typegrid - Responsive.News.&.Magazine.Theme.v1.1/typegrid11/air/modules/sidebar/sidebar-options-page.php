                    ...
                    <div>
                        <table class="air-table" cellpadding="0" cellspacing="0">
							...
							<?php foreach ( $sidebars as $id => $name ): ?>
                                <tr>
                                    <td class="name">
                                        <input name="air-sidebar[sidebars][<?php echo $i; ?>][name]" type="text"
                                               value="<?php echo $name; ?>">
                                    </td>
                                    <td class="id">
                                        <input name="air-sidebar[sidebars][<?php echo $i; ?>][id]" type="text"
                                               value="<?php echo $id; ?>">
                                    </td>
                                    <td class="actions">
                            ...
                            <tr>
                                <td colspan="4">
                                    <p class="air-credit">Edit widget areas in <a href="widgets.php">Appearance >
                                            Widgets</a></p>
                                </td>
                            </tr>
                            </tfoot>
