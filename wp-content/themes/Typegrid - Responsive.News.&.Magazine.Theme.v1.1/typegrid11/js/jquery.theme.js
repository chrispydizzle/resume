...
(function ($, window, document, undefined) {
    var methods = {
        init: function () {
            ...
            var options = $.extend({}, {"submenu": "ul.sub-menu", "speed": "fast"}, opts);
            ...
            if (width < options.deviceWidth) {
                ...
                $("<option />", {"selected": "selected", "value": "", "text": options.defaultOption}).appendTo(menu);
            ...
            var options = $.extend({}, {"trigger": ".title a", "toggle": ".inner"}, opts);
            return this.each(function () {
                var container = $(this);
            ...
            var options = $.extend({}, {"button": ".alert-close"}, opts);
            return this.each(function () {
                var alert = $(this);
            ...
            var options = $.extend({}, {"tabs": ".tab", "trigger": ".tabs-nav a"}, opts);
            return this.each(function () {
            ...
            var options = $.extend({}, {"trigger": ".title", "toggle": ".inner"}, opts);
            return this.each(function () {
            ...
            var options = $.extend({}, {"tabs": ".wpb-tab", "trigger": ".wpb-tabs a"}, opts);
            return this.each(function () {
                var tabs = $(this).find(options.tabs);
                var trigger = $(this).find(options.trigger);
                trigger.filter(":first").addClass("active");
            ...
            var options = $.extend({}, {"speed": "slow"}, opts);
            return this.each(function () {
            ...
            var options = $.extend({}, {"pushDiv": "#sticky-footer-push"}, opts);
            var footer = $(this);
            ...
            var options = $.extend({}, {"currentClass": "current"}, opts);
            return this.each(function () {
            ...
            var options = $.extend({}, {"container": "#portfolio", "isotope": true}, opts);
            return this.each(function () {
