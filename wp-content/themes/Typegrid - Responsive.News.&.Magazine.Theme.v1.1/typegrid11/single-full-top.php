        ...
        <div class="pad group">
            <header class="entry-header">
				...
				<?php if ( ! wpb_option( 'post-hide-comments-single' ) ): ?>
                    <a class="entry-comments" href="<?php comments_link(); ?>"><i
                                class="icon-comments-alt"></i><?php comments_number( '0', '1', '%' ); ?></a>
				<?php endif; ?>
                <ul class="entry-meta">
					...
					<?php if ( ! wpb_option( 'post-hide-categories-single' ) ): ?>
                        <li class="category">In <?php the_category( ' &middot; ' ); ?></li><?php endif; ?>
			...
			<?php if ( get_post_format() ) {
				get_template_part( 'partials/post-formats-full' );
			}; ?>
        </div>
    </div><!--/.content-->
    ...
    <div class="main group <?php echo wpb_option( 'general-sidebar', 'sidebar-right' ); ?>">
        ...
        <div class="content-part">
            <div class="pad group">
                ...
                <article id="entry-<?php the_ID(); ?>" <?php post_class( 'entry group' ); ?>>
                    ...
                    <div class="entry-part text">
						...
						<?php wp_link_pages( array(
							'before' => '<div class="entry-page-links">' . __( 'Pages:', 'typegrid' ),
							'after'  => '</div>'
						) ); ?>
                        <div class="clear"></div>
				...
				<?php if ( air_related_posts::get_option( 'enable' ) ) {
