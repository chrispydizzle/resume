                ...
                jQuery("#jquery_jplayer_<?php the_ID(); ?>").jPlayer({
                    ready: function () {
                        jQuery(this).jPlayer("setMedia", {
							<?php if ( in_array( 'mp3', $formats ) ) {
								echo 'mp3: "' . $meta['_audio_mp3_url'][0] . '",' . "\n";
							} ?>
							<?php if ( in_array( 'm4a', $formats ) ) {
								echo 'm4a: "' . $meta['_audio_mp3_url'][0] . '",' . "\n";
							} ?>
							<?php if ( in_array( 'oga', $formats ) ) {
								echo 'oga: "' . $meta['_audio_ogg_url'][0] . '",' . "\n";
							} ?>
                        });
                    },
    ...
    <div class="entry-format">
        <div class="image-container">
			...
			<?php if ( has_post_thumbnail() ) {
				the_post_thumbnail( 'size-thumbnail-large' );
			} ?>
			<?php if ( isset( $imagesize ) && ! has_post_thumbnail() ) {
				echo '<img src="' . $imagesize[0] . '" alt="' . $images[0]->post_title . '" >';
			} ?>
