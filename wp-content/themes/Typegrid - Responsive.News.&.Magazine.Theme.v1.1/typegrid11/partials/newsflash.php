                                ...
                                <ul>
                                    <li class="grid first">
                                        <div class="pad">
                                            ...
                                            <p>
												<?php if ( wpb_option( 'newsflash-most-popular' ) == '0' ) {
													_e( 'All time', 'typegrid' );
												} ?>
												<?php if ( wpb_option( 'newsflash-most-popular' ) == 'month' ) {
													_e( 'This month', 'typegrid' );
												} ?>
												<?php if ( wpb_option( 'newsflash-most-popular' ) == 'week' ) {
													_e( 'This week', 'typegrid' );
												} ?>
												<?php if ( wpb_option( 'newsflash-most-popular' ) == 'day' ) {
													_e( 'Last 24 hours', 'typegrid' );
												} ?>
                                            </p>
                                            <i class="icon-star"></i>
                                        </div>
