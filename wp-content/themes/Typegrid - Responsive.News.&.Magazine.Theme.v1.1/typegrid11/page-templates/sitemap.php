                ...
                <article id="entry-<?php the_ID(); ?>" <?php post_class( 'entry group' ); ?>>
                    ...
                    <div class="sitemap group">
                        ...
                        <div class="grid one-third">
                            ...
                            <ul><?php $archive_query = new WP_Query( 'posts_per_page=1000' );
                        ...
                        <div class="grid one-third last">
                            ...
                            <ul>
                                <li><a title="Full content"
                                       href="feed:<?php bloginfo( 'rss2_url' ); ?>"><?php _e( 'Main RSS', 'typegrid' ); ?></a>
                                </li>
                                <li><a title="Comment Feed"
                                       href="feed:<?php bloginfo( 'comments_rss2_url' ); ?>"><?php _e( 'Comment Feed', 'typegrid' ); ?></a>
                                </li>
                            </ul>
