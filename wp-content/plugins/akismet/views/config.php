                                ...
                                <td align="left">
                                    <fieldset>
                                        ...
                                        <p><label for="akismet_comment_form_privacy_notice_hide"><input type="radio"
                                                                                                        ...
                                                                                                        value="hide" <?php echo in_array( get_option( 'akismet_comment_form_privacy_notice' ), array(
													'display',
													'hide'
												) ) ? checked( 'hide', get_option( 'akismet_comment_form_privacy_notice' ), false ) : 'checked="checked"'; ?> /> <?php esc_html_e( 'Do not display privacy notice.', 'akismet' ); ?>
                                            </label></p>
                                    </fieldset>
