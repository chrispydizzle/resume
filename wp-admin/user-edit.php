					...
					<?php if ( ! ( IS_PROFILE_PAGE && ! $user_can_edit ) ) : ?>
                        <tr class="user-rich-editing-wrap">
                            ...
                            <td><label for="rich_editing"><input name="rich_editing" type="checkbox" id="rich_editing"
                                                                 value="false" <?php checked( 'false', $profileuser->rich_editing ); ?> /> <?php _e( 'Disable the visual editor when writing' ); ?>
                                </label></td>
                        </tr>
					<?php endif; ?>
					<?php
                        ...
                        <tr class="user-syntax-highlighting-wrap">
                            ...
                            <td>
                                <label for="syntax_highlighting"><input name="syntax_highlighting" type="checkbox"
                                                                        ...
                                                                        value="false" <?php checked( 'false', $profileuser->syntax_highlighting ); ?> /> <?php _e( 'Disable syntax highlighting when editing code' ); ?>
                                </label>
                            </td>
                        </tr>
					<?php endif; ?>
					...
					if ( ! ( IS_PROFILE_PAGE && ! $user_can_edit ) ) :
                        ...
                        <tr class="user-comment-shortcuts-wrap">
                            ...
                            <td><label for="comment_shortcuts"><input type="checkbox" name="comment_shortcuts"
                                                                      ...
                                                                      value="true" <?php checked( 'true', $profileuser->comment_shortcuts ); ?> /> <?php _e( 'Enable keyboard shortcuts for comment moderation.' ); ?>
