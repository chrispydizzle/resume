...
?>
    <div class="wrap about-wrap full-width-layout">
        ...
        <div class="has-2-columns is-fullwidth">
            <div class="column">
                <h4>
                    <a href="https://make.wordpress.org/core/2019/03/26/coding-standards-updates-for-php-5-6/"><?php _e( 'PHP Version Bump' ); ?></a>
                </h4>
            ...
            <div class="column">
                <h4>
                    <a href="https://make.wordpress.org/core/2019/04/24/developer-focused-privacy-updates-in-5-2/"><?php _e( 'Privacy Updates' ); ?></a>
                </h4>
        ...
        <div class="has-2-columns is-fullwidth">
            <div class="column">
                <h4>
                    <a href="https://make.wordpress.org/core/2019/04/24/miscellaneous-developer-updates-in-5-2/"><?php _e( 'New Body Tag Hook' ); ?></a>
                </h4>
                <p>
					<?php
					printf(
            ...
            <div class="column">
                <h4>
                    <a href="https://make.wordpress.org/core/2019/03/25/building-javascript/"><?php _e( 'Building JavaScript' ); ?></a>
                </h4>
