...
function _wp_personal_data_export_page() {
    ...
    <div class="wrap nosubsub">
        ...
        <form action="<?php echo esc_url( admin_url( 'tools.php?page=export_personal_data' ) ); ?>" method="post"
...
function _wp_personal_data_removal_page() {
    ...
    <div class="wrap nosubsub">
        ...
        <form action="<?php echo esc_url( admin_url( 'tools.php?page=remove_personal_data' ) ); ?>" method="post"
              class="wp-privacy-request-form">
...
abstract class WP_Privacy_Requests_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		if ( isset( $_REQUEST['order'] ) && in_array( strtoupper( $_REQUEST['order'] ), array(
				'ASC',
				'DESC'
			), true ) ) {
		...
		switch ( $status ) {
			...
			case 'request-confirmed':
                ...
                <span style="display:none"
                      class="export-personal-data-processing button updating-message"><?php _e( 'Sending Email...' ); ?></span>
                <span style="display:none"
                      class="export-personal-data-success success-message"><?php _e( 'Email sent.' ); ?></span>
                <span style="display:none"
                      class="export-personal-data-failed"><?php _e( 'Email could not be sent.' ); ?> <button
                            type="button"
	...
	public function column_next_steps( $item ) {
		...
		switch ( $status ) {
			...
			case 'request-confirmed':
                ...
                <span style="display:none"
                      class="remove-personal-data-processing button updating-message"><?php _e( 'Erasing Data...' ); ?></span>
                <span style="display:none"
                      class="remove-personal-data-failed"><?php _e( 'Erasing Data has failed.' ); ?> <button
                            type="button"
