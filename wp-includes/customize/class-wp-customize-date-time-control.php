        ...
        <div class="date-time-fields {{ data.includeTime ? 'includes-time' : '' }}">
            ...
            <fieldset class="time-row clear">
                ...
                <div class="time-fields clear">
                    ...
                    <# } #>
                    <abbr class="date-timezone" aria-label="<?php esc_attr_e( 'Timezone' ); ?>"
                          title="<?php echo esc_attr( $timezone_info['description'] ); ?>"><?php echo esc_html( $timezone_info['abbr'] ); ?></abbr>
                </div>
            </fieldset>
            <# } #>
        </div>
