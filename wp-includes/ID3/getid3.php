...
class getID3 {
	// public: Settings
	const VERSION = '1.9.14-201706111222';        // CASE SENSITIVE! - i.e. (must be supported by iconv()). Examples:  ISO-8859-1  UTF-8  UTF-16  UTF-16BE
	...
	public function analyze( $filename, $filesize = null, $original_filename = '' ) {
		try {
			...
			if ( ! empty( $determined_format['iconv_req'] ) && ! function_exists( 'mb_convert_encoding' ) && ! function_exists( 'iconv' ) && ! in_array( $this->encoding, array(
					'ISO-8859-1',
					'UTF-8',
					'UTF-16LE',
					'UTF-16BE',
